...
function show_list() {
	...
	echo '<h1>Brugerliste</h1>
		...
		<tr> <th>Brugernavn<br/><span class="help">Ret bruger</span></th> <!-- <th>Spejdernet</th> --> <th>Fornavn<br/><span class="help">Vis bruger</span></th> <th>Efternavn</th> <th>Team-navn</th> <th>E-mail</th> <th>Telefon</th> <th>Adresse</th> <!-- <th>Alder</th> --> <th>Afdeling</th> <th>Rolle</th> <th>Antal</th> <!-- <th>Underlejr</th> --> <th>Noter</th> </tr>';
	$lastRole = null;
	$emailSum = null;
	$userCount = 0;
	$count = 0;
