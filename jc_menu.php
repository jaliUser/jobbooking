...
echo '
	...
	'.(user_is_admin() || user_is_consultant() ? '<tr><td><a href="jc_user.php?action=show_list">Vis brugere</a></td><td class="help"></td></tr>' :'').'
	'.(user_is_admin() || user_is_consultant() ? '<tr><td><a href="jc_user.php?action=show_helpers_limit">Vis brugere < 8 timer</a></td><td class="help"></td></tr>' :'').'
